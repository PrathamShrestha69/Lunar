  ...
  return (
    <Link href={`/${curtain.id}`} className="block font-[DM_Sans]">
      <div
        ...
        className="bg-[#F5F5F5] h-[60vw] lg:h-[36vw] w-[45vw] lg:w-[26vw] rounded-2xl lg:px-5 cursor-pointer overflow-hidden relative group flex flex-col justify-between"
      >
        ...
        <div className="flex flex-col gap-1 px-4 pb-4 pt-2 text-black">
