...
const HeroWomen = () => {
  const womenShoe =
    shoe.find((item) => item.name === "Trailblaze Runner") || shoe[0];
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://framerusercontent.com/images/FsI2lMOKSjog9l8dycXZcNAUHc.png?width=1024&height=1024')",
        }}
      >
